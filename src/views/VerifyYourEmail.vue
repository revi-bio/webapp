...
<template>
  <div class="bg-zinc-900 text-zinc-200 min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <main class="flex flex-col items-center text-center gap-4 z-20 p-4">
      <p class="text-4xl font-bold">Please verify your email!</p>
      <div>
        <p class="text-lg text-zinc-400">We have sent you an email with a verification link.</p>
        <p class="text-lg text-zinc-400">Please click on the link to verify your email address.</p>
      </div>
      <RouterLink to="/login">
      ...
      <div>
        <p class="text-zinc-400">If you have not received the email, please check your spam folder.</p>
      </div>
      <p class="text-zinc-400">Thank you for your registration!</p>
